...
def test_equipment_supplier_tracing_reuses_global_company_identity(tmp_path: Path) -> None:
    ...
    assert service.repository.get_equipment_suppliers(
        ("Equipment", "equipment:optical_testing_equipment")
    ) == [("Company", "company:TER")]
