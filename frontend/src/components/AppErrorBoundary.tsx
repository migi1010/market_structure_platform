  ...
  render() {
    ...
    return (
      <div className="flex min-h-screen w-full items-center justify-center bg-[#0A0C10] px-6 text-[#E6EDF3]">
        <div className="max-w-lg rounded-2xl border border-[#2B313C] bg-[#161B22] p-8 text-center shadow-sm">
          ...
          <button
            ...
            className="mt-6 rounded-2xl border border-amber-400/20 bg-amber-400/10 px-5 py-3 text-sm font-black text-amber-200 transition hover:border-amber-200 hover:bg-amber-400/10"
          >
            Try Again
          </button>
        </div>
