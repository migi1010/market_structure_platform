...
export default function TerminalRailButton({
  ...
  return (
    ...
    >
      {icon}
      <span className="pointer-events-none absolute left-[48px] z-[100] hidden whitespace-nowrap rounded-md border border-[var(--theme-border-strong)] bg-[var(--theme-panel-hover)] px-2 py-1 text-[11px] font-semibold text-[var(--theme-text)] group-hover:block">
        {label}
