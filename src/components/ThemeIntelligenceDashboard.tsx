          ...
          <div className="space-y-3">
            {supplyLeaders.map((leader) => (
              ...
              >
                ...
                <p className={(leader.change_percent ?? 0) >= 0 ? "font-mono text-sm font-semibold text-emerald-300" : "font-mono text-sm font-semibold text-rose-300"}>
                  {pct(leader.change_percent)}
                </p>
              </button>
            ))}
