...
def test_networkx_export_supports_material_paths_and_supplier_tracing(tmp_path: Path) -> None:
    ...
    assert nx.has_path(graph, ("Theme", "hbm"), ("Material", "material:photoresist"))
    assert nx.has_path(
        graph,
